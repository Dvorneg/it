...
public class EquipmentTestData {
    ...
    public static final Equipment equipment1 = new Equipment(1,"company1","description1",  "responsible_person1", of(2021, 1, 11), TypeOf.OFFICE_EQUIPMENT);
    public static final Equipment equipment2 = new Equipment(2,"company21","description2",  "responsible_person2", of(2022, Month.FEBRUARY, 2), TypeOf.OFFICE_EQUIPMENT);
